...
function kthSmallestPair(nums, k) {
...
// console.log(kthSmallestPair([3, 1, 4, 1, 5], 2));
// console.log(kthSmallestPair([1, 2, 3, 4, 5], 1));
// console.log(kthSmallestPair([1, 3, 1, 5, 4], 0));

// 278 => Degree of an array
...
const ShortestSubArr = (nums) => {
  ...
  for (let key in obj) {
    if (obj[key] === updateVal) {
      const [firstInd, lastInd] = [
        nums.indexOf(parseInt(key)),
        nums.lastIndexOf(parseInt(key)),
      ];
      const length = lastInd - firstInd + 1;
...
// console.log(ShortestSubArr([1, 2, 2, 3, 1]));
// console.log(ShortestSubArr([1, 2, 2, 3, 1, 4, 2]));
